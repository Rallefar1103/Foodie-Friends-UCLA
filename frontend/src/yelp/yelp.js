...
const getNewRestaurants = (zipcode) => {
    ...
    console.log(url);
    fetch(url, {
        headers: {Authorization: "Bearer FZ8e9ga7HDdTbuMPC8Qbp02mBK0XrOmzWRQNOVof_f0p0RXABGesdXBacmGIfLVsSl3vjAjbHmbeZKR8EFOO-vhVAg2-aSAC_FbYjgBHJ3a8Dx1ppvXy4SOEGdZjY3Yx"}
    })
    .then((res) => {
        return res.json();
    })
